    ...
    return (
        <div className="bg-light-grey">
            <div className="container mx-auto px-4">
                <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-8 pt-8 pb-16 xl:pb-0">
                    <div>
                    ...
                    <div className="flex justify-center lg:justify-end lg:pt-8">
                        <BorderImage src="/hero/hero.png" alt="Stwórz wyjątkowy dziennik wspomnień dla swojego dziecka" width={584} height={674} containerClassName="w-[335px] md:w-[400px] xl:w-[584px] aspect-[584/674] border-[20px] xl:border-[30px] xl:border-b-0" className="object-cover object-top" />
                    </div>
                </div>
            </div>
        </div>
